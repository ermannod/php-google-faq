    ...
    <main class="flex">
      <div class="container">
        ...
        foreach ($faq as $value) {
          echo $value['question'] . '<p class="txsize">' . $value['answer'] . '</p>';
        }
        ?></h2>
      </div>
    </main>
